...
public class PurchaseReportServiceImpl implements PurchaseReportService
{
    ...
    @Autowired
    private PurchaseReportDao purchaseReportDao; // 多表查询用dao
    ...
    public TableData<PurchaseReportVO> listPage(PageParam pageParam, PurchaseReportParam param,Integer userId)
    {
        ...
        return purchaseReportDao.queryPage(pageParam, param);
    }
    ...
    {
        return purchaseReportDao.queryList();
    }
    ...
    {
    	dataAuthority(userId,param);
        return purchaseReportDao.count(param);
    }
