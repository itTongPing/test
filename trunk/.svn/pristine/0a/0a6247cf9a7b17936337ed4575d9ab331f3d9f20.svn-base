...
var TableInit = function()
{
	...
	oTableInit.Init = function()
	{
		...
		bootstrapTable = $('#fbaTransferTable').bootstrapTable(
	            {
	                url:'/report/centerStock/search/fbaTransfer', // 请求后台的URL（*）
	                method: 'get', // 请求方式（*）
	                ...
	                columns : fbaColumns,
	                    onLoadSuccess: function (data) {
	                    	flyer.scrollBar($('#fbaTransferTable')); //初始化滚动条
...
{
	 keyNumbers = [];
	$("#fbaTransferTable").bootstrapTable('destroy');
	var oTable = new TableInit();
    oTable.Init();
}
//重置搜索条件
