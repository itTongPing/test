...
var TableInit = function()
{
	...
	oTableInit.Init = function()
	{
		...
		var overSeaStockTransferColumns = [];
		//-----列名前部分
		overSeaStockTransferColumns.push(
				{
                    field : 'transferNo',
                    title : '调拨单号',
                    align : 'center',
		...
		bootstrapTable = $('#overseaStockTransferTable').bootstrapTable(
	            {
	                url:'/report/centerStock/search/overseaStockTransfer', // 请求后台的URL（*） /report/centerStock/search/fbaStock
	                method: 'get', // 请求方式（*）
	                ...
	                columns : overSeaStockTransferColumns,
	                    onLoadSuccess: function (data) {
	                    	flyer.scrollBar($('#overseaStockTransferTable')); //初始化滚动条
...
{
	 keyNumbers = [];
	$("#overseaStockTransferTable").bootstrapTable('destroy');
	var oTable = new TableInit();
    oTable.Init();
}
//重置搜索条件
