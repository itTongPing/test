DROP VIEW IF EXISTS aukey_report.view_stock_lock;
CREATE VIEW aukey_report.view_stock_lock AS 
SELECT
	rt.requirement_no,
...
UNION ALL
	SELECT
		cis.requirement_no,
		3    AS '法人主体id',
		IFNULL(req.dept_id,0)    AS '需求部门id',
		null AS '品类Id',
		0    AS '含税',
		null AS '运输方式',
		cis.sku,
	...
	left join supply_chain.requirement req on cis.requirement_no=req.requirement_no;